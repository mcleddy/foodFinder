...
$(document).ready(function () {
    ...
    console.log(results[i]);
    var ingredientList = ($("#ingredients-go-here1").text("Ingredients: " + results[1].recipe.ingredientLines.toString([i])), $("#ingredients-go-here2").text("Ingredients: " + results[0].recipe.ingredientLines.toString([i])), $("#ingredients-go-here3").text("Ingredients: " + results[2].recipe.ingredientLines.toString([i])), $("#ingredients-go-here4").text("Ingredients: " + results[4].recipe.ingredientLines.toString([i])));
    var cooktime=($("#cooking-time-goes-here1").text("Cooking Time: " + results[1].recipe.totalTime +" minutes"), $("#cooking-time-goes-here2").text("Cooking Time: " + results[0].recipe.totalTime +" minutes"), $("#cooking-time-goes-here3").text("Cooking Time: " + results[2].recipe.totalTime +" minutes"), $("#cooking-time-goes-here4").text("Cooking Time: " + results[3].recipe.totalTime +" minutes"));
    $("#recipe-card1").append($("<a href="+(results[1].recipe.url+ ">Directions</a>")));
    $("#recipe-card2").append($("<a href="+(results[0].recipe.url+ ">Directions</a>")));
    $("#recipe-card3").append($("<a href="+(results[2].recipe.url+ ">Directions</a>")));
    $("#recipe-card4").append($("<a href="+(results[3].recipe.url+ ">Directions</a>")));
    var recipeImage=new Image(200, 200);
    recipeImage.src=results[1].recipe.image
    document.getElementById("pic-goes-here1").appendChild(recipeImage);
    var recipeImage=new Image(200, 200);
    recipeImage.src=results[0].recipe.image
    document.getElementById("pic-goes-here2").appendChild(recipeImage);
    var recipeImage=new Image(200, 200);
    recipeImage.src=results[2].recipe.image
    document.getElementById("pic-goes-here3").appendChild(recipeImage);
    var recipeImage=new Image(200, 200);
    recipeImage.src=results[3].recipe.image
    document.getElementById("pic-goes-here4").appendChild(recipeImage);
    console.log(recipeImage);
    console.log(results);
    console.log(recipeDiv);
